...
KingMap.Label=function(map,options){
    ...
    var label;
        var opts={
            ...
            if (map.apiType == "AMap") {
                ...
                delete labelOptionStyle.option.offsets;
                ...
                delete labelOptionStyle.option.offsets;
                label = new BMap.Label(labelOptionStyle.option.text, {offset:labelOptionStyle.option.offset,position: new BMap.Point(labelOptionStyle.option.position[0], labelOptionStyle.option.position[1])});  // 创建文本标注对象
                label.setStyle(labelOptionStyle.style);
    ...
    return {
        deleteKp:deleteLabel,
        getLabelKp:getLabel,
        setContentKp:setContent,
        getContentKp:getContent,
        setStyleKp:setStyle,
        setPositionKp:setPosition,
